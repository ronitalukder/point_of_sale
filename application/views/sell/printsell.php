            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="print-logo">
                     <h3><img src="<?php echo base_url();?>/template/assets/img/logo2.png"></h3>
                    </div>
                </div>
            </div>
                            ...
                            <h3 class="qutationTotal">Total Amount : <?php echo $intotal;?></h3>
                             ...
                             <h5>Date : <?php echo $indate;?></h5>
                              ...
                              <h4 class="print-btn pull-right"><button class="btn btn-primary btn-md" id="invoicePrint">Print</button></h4>
                               ...
                               <input type="hidden" value="<?php echo $inId;?>" id="inId"/>
...
$(document).ready(function() {
    $("#invoicePrint").click(function(){
        ...
        var w = window.open('../invoiceprint/'+id,'name','width=1000px,height=500');
w.onload = w.print;
w.focus();
