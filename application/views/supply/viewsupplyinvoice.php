                ...
                <div class="col-lg-12 print-table">
                    ...
                    <table class="table table-bordered">
                                    ...
                                    foreach($purchase as $value){
                                        ...
                                        $itemTotalPrice=$purPrice*$purQty;
                            ...
                            <h3 class="qutationTotal">Total Amount : <?php echo $total;?></h3>
                             <h3 class="qutationTotal">Cash : <?php echo $cash;?></h3>
                             <h3 class="qutationTotal">Due : <?php echo $due;?></h3>
